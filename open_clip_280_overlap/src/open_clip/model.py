...
class VisualTransformer(nn.Module):
    def __init__(
        ...
        self.grid_size = ( (self.image_size[0] - 2) // (self.patch_size[0] - 2), (self.image_size[1]-2) // (self.patch_size[1] - 2) )
        self.output_dim = output_dim
        self.conv1 = nn.Conv2d(in_channels=3, out_channels=width, kernel_size=patch_size, stride=patch_size - 2, bias=False)
