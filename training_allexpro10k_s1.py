...
INIT_LR = 0.02 
WEIGHT_DECAY = 1e-4
MILESTONES = [EPOCHS//3 ,2*EPOCHS//3]#[1]#
COMMENT = 'stage1_vith_224_all_last2layers'
...
#weight_try = torch.load(  os.path.join('/home/shaoshihao/landmark/result','arcface all vith 18 last and middle first (3).pth')     )
