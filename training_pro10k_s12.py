...
COMMENT = 'stage12_vith_290_overlap_pro10k_last2layer'
...
weight_try = torch.load(  os.path.join('result','stage11_vith_290_overlap_pro10k_lastlayer.pth')     )
